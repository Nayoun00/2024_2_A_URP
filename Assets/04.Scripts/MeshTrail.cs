...
public class MeshTrail : MonoBehaviour
{
    ...
    public float animSpeedBoost = 1.5f;        //잔상효과 사용시 애니메이션 속도 증가량
    ...
    public string shaderVarRef;                 //세이더에서 사용할 변수 이름(Alpha)
    public float shaderVarRate = 0.1f;          //셰이더 효과의 변화 속도
    public float shaderVarRefreshRate = 0.05f;  //세이더 효과가 업데이트 되는 시간 간격
